...
const expectedColumns: ExpectedColumn[] = [
  ...
  { table: "votes", column: "vote_id", dataType: "integer", nullable: false },
  { table: "votes", column: "vote_round", dataType: "integer", nullable: false },
  { table: "votes", column: "game_id", dataType: "integer", nullable: false },
  { table: "votes", column: "created_at", dataType: "timestamp without time zone", nullable: false },
