-- This version uses \COPY which works with psql command line tool
...
\copy temp_games_csv FROM 'd:/repos/ps2-challenge-website/csv/allgames.csv' CSV HEADER

-- ...existing code from INSERT INTO platform_types onwards...
